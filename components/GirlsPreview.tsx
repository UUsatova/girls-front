            ...
            >
              <div className="overflow-hidden aspect-[3/4] w-full">
                ...
                <div className="relative w-full h-full">
                  ...
                  {/* New Badge */}
                  {girl.isNew && (
                    <div className="absolute top-4 left-4 px-3 py-1.5 bg-[#ff0066]/90 backdrop-blur-sm rounded-lg flex items-center gap-1.5 shadow-lg shadow-[#ff0066]/30 z-10">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 flex flex-col gap-3">
                    <div>
                      <div className="flex items-baseline gap-2 mb-2">
                        <h3 className="text-2xl md:text-3xl font-bold text-white neon-glow">
                          {girl.name}
                        </h3>
                        <span className="text-lg font-light text-[#cccccc]">
                          {girl.age}
                        </span>
                      </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {girl.tags.map((tag, i) => (
                        <span
                          key={i}
                          className="text-[10px] uppercase tracking-wider px-2.5 py-1 rounded-md bg-[#ff0066]/20 border border-[#ff0066]/40 text-[#ff0066] neon-glow"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <div className="mt-2">
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-[#ff0066] text-white font-medium text-sm shadow-lg shadow-[#ff0066]/30 neon-glow"
                      >
